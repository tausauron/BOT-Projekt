...
class TestUnternehmen {
	...
	@Test
	void testFreeSlot(){
		unt.getKurse().put(Typ.A, new Kurse(null, new ArrayList<>(), unt, new Zeitslot(Typ.A)));
		System.out.println(unt.freeSlot());	
		System.out.println(unt.getKurse().values().size());
		assertEquals(unt.freeSlot(), true);	

		unt.getKurse().put(Typ.B, new Kurse(null, new ArrayList<>(), unt, new Zeitslot(Typ.B)));
		unt.getKurse().put(Typ.C, new Kurse(null, new ArrayList<>(), unt, new Zeitslot(Typ.C)));
		System.out.println(unt.getKurse().values().size());
